...
#                            Name = summon(op.param2)
		    ...
		    red.sendText(msg.to,"Khusus red")
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        red.sendText(msg.to,"Tidak Ada Yang Pending")
                else:
                    red.sendText(msg.to,"Tidak Bisa Digunakan Diluar Group")
                ...
                if msg.toType == 2:
                    ...
                    red.updateGroup(X)
                    red.sendText(msg.to,"Url Sudah Di Nonaktifkan")
		...
		if msg.from_ in admin:
		    ...
		    red.sendText(msg.to,"Khusus red")
                ...
                wait["Contact"] = True
                red.sendText(msg.to,"Contact Sudah Aktif")

            elif msg.text in ["K off","Contact off"]:
                wait["Contact"] = False
                red.sendText(msg.to,"Contact Sudah Di Nonaktifkan")
                

            elif msg.text in ["Alwaysread on"]:
                wait["alwaysRead"] = True
                red.sendText(msg.to,"Always Read Sudah Aktif")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        red.sendText(msg.to,"Sambutan Di Aktifkanヾ(*´∀｀*)ﾉ")
                else:
                    wait["Sambutan"] = True
                    if wait["lang"] == "JP":
                        red.sendText(msg.to,"Sudah Onヽ(´▽｀)/")

            elif msg.text in ["Sambutan off"]:
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        red.sendText(msg.to,"Sambutan Di Nonaktifkan(　＾∇＾)")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                        red.sendText(msg.to,"Sudah Off(p′︵‵。)")
                ...
                wait["Sider"] = True
                red.sendText(msg.to,"Siap On Cek Sider")
                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    red.sendText(msg.to, "Cek Sider Off")
                else:
                    red.sendText(msg.to, "Heh Belom Di Set")                         
