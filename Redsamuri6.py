...
cl = LINETCR.LINE() 
cl.login(token="EpfxQXQ94LB0NYbsSR26.Lkg8ohUsFOz1yZrKJtfpHG.AgaQ3j6n9+kd6pbMOYYxKQV4uVv1zKAlMeh/Ze7FQIg=")
cl.loginResult()

ki = LINETCR.LINE() 
ki.login(token="EpEFGxSACJtNNwWM12N8.wZxjCuYJwwfJnE+TIiu3Qa.QpNzbAZovH8yLIvOwY7+y03pF9c6QZEE3mnSPAfBixs=")
ki.loginResult()

ki2 = LINETCR.LINE() 
ki2.login(token="EpKRag4nRWs5iT81cK17.VLk4KX7UlHwHTOK3FJ5wnW.CBfSzhJF61Z9c8bnv5xFBpk2gNB5wlwExbm2HvYVzBU=")
ki2.loginResult()

ki3 = LINETCR.LINE() 
ki3.login(token="Ept7zTRaZ24QC9FaPRZ9.gU3VI4Ik4qJzA6Y8uftMEq.yLqdkN/kt2VSVB0cw1XVGXkIsOseNodu4ULckrBrHXM=")
ki3.loginResult()

ki4 = LINETCR.LINE() 
ki4.login(token="EphVxwKUvrWZJf1asL46.MC3I4QsKSrV9tmqyKt6jHG.0Bd0lLX2mV2LN0TV62fqnunt6rt6wf225jHHPsiI7Pw=")
ki4.loginResult()

ki5 = LINETCR.LINE() 
ki5.login(token="EpoeCwFoLNlhizAWEmtd.ggx7QWxQIfYNVuGEW1YAhq.ovfPAkrPEv72pWKrNP1euV2Rknzzqg069R0HhXcPTg8=")
ki5.loginResult()

ki6 = LINETCR.LINE() 
ki6.login(token="Ep9Llb8nsrK6l8LBwgU7.zwSmQzsHYBrI/F629A4XDW.miLhVqfatk2yvjpcId084g7A0QLPZ/4ujIGypD745cI=")
ki6.loginResult()
