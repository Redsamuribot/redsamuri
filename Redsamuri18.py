...
cl = ASUL.LINE()
cl.login(token="EpmkxJL2YIlMAOpndmu6.MC3I4QsKSrV9tmqyKt6jHG.W9a7HVrZX0K9tc9GpkU61hLgYQVYJw80EMhUuzZiji8=")
cl.loginResult()

ki = ASUL.LINE()
ki.login(token="Ep45ilmx8Y5gNOOKL6d3.rQbq68XMQqTh/UyLzuFmuW.rK9BZM+FfpA8ArAUIZqqEeEJlMfjKIp/otzDAQpcwSc=")
ki.loginResult()

kk = ASUL.LINE()
kk.login(token="EplAwyYtXX1dnzMJquRd.ggx7QWxQIfYNVuGEW1YAhq.wwYdYVPCjyUO/Yd3pq0QQUhc47H7fMP/8BypASs6bOM=")
kk.loginResult()

kc = ASUL.LINE()
kc.login(token="EpPxPwn4x7ZmIjwHoSw9.gU3VI4Ik4qJzA6Y8uftMEq.kPR1/LP9T4dKFoAs49ftkNRaWUs65mg5iwcFrfXsi6k=")
kc.loginResult()

kd = ASUL.LINE()
kd.login(token="Ep8C6JKfXIngHwbonFu7.VLk4KX7UlHwHTOK3FJ5wnW.sNWlVYnDxRza3DORTtleim+m4/a5+E7hS8CbO827qz8=")
kd.loginResult()

ke = ASUL.LINE()
ke.login(token="Ep7L90ylo6NUUlSBP538.wZxjCuYJwwfJnE+TIiu3Qa.jlSpzNgLTjmWrU9ZjH0rG36lW8Gu+s9/D59hRIEEmL8=")
ke.loginResult()

kf = ASUL.LINE()
kf.login(token="EpaQASbmm9EvjtGfF7W7.zwSmQzsHYBrI/F629A4XDW.ffnWauIeVaCUSuyCjwL02bLaW1hUpB7jc6WCjBCTUqY=")
kf.loginResult()
...
#==================================================
				...
				msg.contentType = 13
				msg.contentMetadata = {'mid': 'u99cde2e2a4a4b11bfd4cc418913e8986'}
				cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ปฎิเสธคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
