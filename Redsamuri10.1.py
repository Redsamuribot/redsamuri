...
ki = LINETCR.LINE()
ki.login(token="EqlCJd8ELUvEBwD97My8.wZxjCuYJwwfJnE+TIiu3Qa.ptsqYuZXwrSfCFDa6dNoVRqbfxSl6EEBrMkgVgKvohA=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqQYiuojsIVJ0uXI8oU7.zwSmQzsHYBrI/F629A4XDW.B70LRj2iJvz8ehHul01XWD0W3CkCo5DlRn0WjRIEJYA=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EqzFBUjI8B1viqla4da9.gU3VI4Ik4qJzA6Y8uftMEq.DSyFLWGVwKsRelfnRmCv2bcCtm6mIy7jVBpWtuq7Glc=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqIj7X6z9phSDiaMWOvd.ggx7QWxQIfYNVuGEW1YAhq.pvbnFeabbE4LMt6qdKVkEOa12J+r/3GYcD87BKwGNnY=")
ki4.loginResult()
...
k1 = LINETCR.LINE()
#kt.login(qr=True)
k1.login(token="EqjD1fA1owSuCxzdpVp8.mvAgYb/vW0eh+44T2zj1ga.6QSW4uNJiucAD3UH8nV07tfci5qDvFqNUyRC4WCdMek=")
k1.loginResult()

k2 = LINETCR.LINE()
#k2.login(qr=True)
k2.login(token="EqOkpru1zwRb2gyxJdy9.th5xFRYfLrNmTFAuPc9Aoq.4q8Y2ZxiceV843Eo+o5SRUDBwf+Rd9ROMC6v+c9djYM=")
k2.loginResult()

k3 = LINETCR.LINE()
#ki.login(qr=True)
k3.login(token="EqkclWTahoRvY30HN7P3.rQbq68XMQqTh/UyLzuFmuW.22O7uj36c3oz1Q9vBLVIDZLX1MXJWDGp7JUC3A1lqa0=")
k3.loginResult()

k4 = LINETCR.LINE()
#k4.login(qr=True)
k4.login(token="EqaOEmpKvjH6O7OuUB63.TAVOkm2wqPizxdXz1JiGmW.1C46Lb3qwMM0BLen/d0HKgNQb/XhJW1CvvnmQS04CLo=")
k4.loginResult()

k5 = LINETCR.LINE()
#k5.login(qr=True)
k5.login(token="EqVLbPafRZ9mAaI1Z6L3.FXP8F/ZJ0UQHfIxYmKf0iW.mYvpkhLLWpKdAO36w2GKiSSHncqdKhB112PKaIPL0b0=")
k5.loginResult()
